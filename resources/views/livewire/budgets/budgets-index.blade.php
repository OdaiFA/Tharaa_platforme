<div>
    ...
    <div class="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3">
        @forelse ($budgets as $item)
            ...
            <a href="{{ route('budgets.show', $budget) }}" wire:key="budget-{{ $budget->id }}" class="group rounded-2xl border border-gray-100 bg-white p-5 shadow-sm transition hover:shadow-md">
