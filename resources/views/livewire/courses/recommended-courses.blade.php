<div>
    ...
    <div class="grid grid-cols-1 gap-5 md:grid-cols-2 lg:grid-cols-3">
        @forelse ($courses as $course)
            <a href="{{ route('courses.show', $course) }}" wire:key="rec-course-{{ $course->id }}" class="group overflow-hidden rounded-2xl border border-gold-200 bg-white shadow-sm transition hover:shadow-md">
