            ...
            <div class="mt-6">
                ...
                @else
                    <button type="button" wire:click="enroll" wire:loading.attr="disabled" wire:target="enroll"
                        class="rounded-xl bg-primary-600 px-6 py-3 font-bold text-white shadow-lg shadow-primary-600/30 hover:bg-primary-700 disabled:opacity-60">
                        <span wire:loading.remove wire:target="enroll">التسجيل في الدورة</span>
                        <span wire:loading wire:target="enroll">جارٍ التسجيل...</span>
                    </button>
                @endif
            </div>
        </div>
