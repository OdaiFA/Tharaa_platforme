...
@section('content')
    <div class="animate-fade-in mx-auto w-full max-w-md rounded-2xl border border-gray-200 bg-white p-8 shadow-xl shadow-primary-900/5">
        <h1 class="text-center text-2xl font-extrabold text-gray-900">تعيين كلمة مرور جديدة</h1>
        ...
        <form method="POST" action="{{ route('password.store') }}" class="mt-6 space-y-4">
            ...
            <div>
                <label for="password" class="mb-1.5 block text-sm font-medium text-gray-700">كلمة المرور الجديدة</label>
